...
class Agent:
    ...
    def get_state(self, game):
        #[isDangerStraight , isDangerRight , isDangerLeft , isDirectionLeft , isDirectionRight , isDirectionUp , isDirectionDown 
    ...
    def train_long_memory(self):
        ...
        states , actions , rewards , next_states , isDones = zip(*mini_sample)
        self.trainer.train_step(states , actions , rewards , next_states , isDones)

    def train_short_memory(self, state , action , reward , next_state , isDone):
        self.trainer.train_step(state , action , reward , next_state , isDone)
...
def train():
    ...
    while True:
        ...
        #remember
        agent.remember(state_old, final_move, reward, state_new, isDone)
        if isDone:
            #train long memory 
            # Experience Replay
            game.reset()
            ...
            plot(play_scores , plot_mean_scores)
